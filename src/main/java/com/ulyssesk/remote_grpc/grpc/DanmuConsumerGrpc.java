...
public final class DanmuConsumerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest,
      com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> getPullDanmuMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "PullDanmu",
  ...
  public static io.grpc.MethodDescriptor<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest,
      com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> getPullDanmuMethod() {
    io.grpc.MethodDescriptor<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest, com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> getPullDanmuMethod;
    if ((getPullDanmuMethod = DanmuConsumerGrpc.getPullDanmuMethod) == null) {
      synchronized (DanmuConsumerGrpc.class) {
        if ((getPullDanmuMethod = DanmuConsumerGrpc.getPullDanmuMethod) == null) {
          DanmuConsumerGrpc.getPullDanmuMethod = getPullDanmuMethod =
              ...
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "PullDanmu"))
              ...
              .setSchemaDescriptor(new DanmuConsumerMethodDescriptorSupplier("PullDanmu"))
              .build();
        }
      }
    }
    return getPullDanmuMethod;
  }
  ...
  public static abstract class DanmuConsumerImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void pullDanmu(com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest request,
        io.grpc.stub.StreamObserver<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getPullDanmuMethod(), responseObserver);
    }
  ...
  public static final class DanmuConsumerStub extends io.grpc.stub.AbstractAsyncStub<DanmuConsumerStub> {
    ...
    public void pullDanmu(com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest request,
        io.grpc.stub.StreamObserver<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> responseObserver) {
      asyncServerStreamingCall(
          getChannel().newCall(getPullDanmuMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DanmuConsumerBlockingStub extends io.grpc.stub.AbstractBlockingStub<DanmuConsumerBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse> pullDanmu(
        com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest request) {
      return blockingServerStreamingCall(
          getChannel(), getPullDanmuMethod(), getCallOptions(), request);
    }
  }
  ...
  private static final int METHODID_PULL_DANMU = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PULL_DANMU:
          serviceImpl.pullDanmu((com.ulyssesk.remote_grpc.grpc.Danmu.DanmuRequest) request,
              (io.grpc.stub.StreamObserver<com.ulyssesk.remote_grpc.grpc.Danmu.DanmuResponse>) responseObserver);
          break;
        default:
